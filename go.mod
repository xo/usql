...
require (
	...
	github.com/apache/arrow/go/arrow v0.0.0-20200829193119-df3bee240be3 // indirect
	github.com/apache/calcite-avatica-go/v4 v4.0.0
	github.com/couchbase/go-couchbase v0.0.0-20200818170519-cfca89524e88 // indirect
