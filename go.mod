...
require (
	...
	github.com/couchbase/go_n1ql v0.0.0-20220120080408-df8fc645e6b9
	...
	github.com/mithrandie/csvq v1.16.0
...
require (
	...
	github.com/envoyproxy/protoc-gen-validate v0.6.4 // indirect
